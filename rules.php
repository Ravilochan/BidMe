...
<div id="fh5co-review" class="fh5co-bg-section" >
		<div class="container">
			...
			<div class="row animate-box row-pb-md" data-animate-effect="fadeInUp">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<span> Beware &amp; Follow </span>
					<h2>Our Rules & Conditions </h2>
					<p> Any Violation to these Rules & Conditions will be punised Accordingly.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 col-sm-4 animate-box" data-animate-effect="fadeInUp">
					<div class="fh5co-post">
						<blockquote>
							<p>&ldquo; Only one account is allowed per person&rdquo;</p>
							<p class="author">  <cite>&mdash; Unique Identification</cite></p>
						</blockquote>
					</div></div>
					...
					<div class="fh5co-post">
						<blockquote>
							<p>&ldquo;If two or more users are working together and performing any illegal or restricted acts , then there auctions are stopped and can result in blocking their accounts &rdquo;</p>
							<p class="author">  <cite>&mdash; No Conspiracies</cite></p>
						</blockquote>
					</div></div></div>
				...
				<div class="col-md-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<div class="review">
						<blockquote>
							<p>&ldquo; Only 7 products are allowed per account over a 28 days time period &rdquo;</p>
							<p class="author"> <cite>&mdash; Not a closing Sale </cite></p>
						</blockquote>
					</div></div>
	...
	<div class="col-md-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<div class="review">
						<blockquote>
							<p>&ldquo; Only 5 auction wins are allowed per day to an account &rdquo;</p>
							<p class="author"> <cite>&mdash; No Monopoly </cite></p>
						</blockquote>
					</div></div>
	    ...
	    <div class="collapse" id="collap2">
				...
				<div class="col-md-6 col-sm-4 animate-box" data-animate-effect="fadeInUp">
					<div class="fh5co-post">
						<blockquote>
							<p>&ldquo; No Bots of any kind are allowed when using the site in any manner &rdquo;</p>
							<p class="author">  <cite>&mdash; No Bots </cite></p>
						</blockquote>
					</div></div>



					<div class="col-md-6 col-sm-8 animate-box" data-animate-effect="fadeInUp">
					<div class="fh5co-post">
						<blockquote>
							<p>&ldquo; Auctions over Rs. 1,00,00,000 are held only once in a week &rdquo;</p>
							<p class="author">  <cite>&mdash; One D-Day</cite></p>
						</blockquote>
					</div></div>
				...
				<div class="col-md-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<div class="review">
						<blockquote>
							<p>&ldquo; Every item open for auction must be verified and validated according to the Terms and Conditions &rdquo;</p>
							<p class="author"> <cite>&mdash; Verified Items</cite></p>
						</blockquote>
					</div></div>
				</div>
	...
	<div class="col-md-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<div class="review">
						<blockquote>
							<p>&ldquo; No Refunds will be provied - Terms and Conditions&rdquo;</p>
							<p class="author"> <cite>&mdash; No Refunds </cite></p>
						</blockquote>
					</div></div>
	</div>	
      <button type="button" class="col-md-2 col-md-offset-5 text-center btn btn-info" data-toggle="collapse" data-target="#collap2">Show More</button>
	  <br><br><br></div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p><button href="LogIn.php"class="btn btn-default">Get In Auction </button></p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-4 wow fadeInLeft" data-wow-delay="0.6s">
						...
						<p>Online auction firm<br> Providing easy handling and interactive experience </p>
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-4 col-sm-4 col-xs-6 col-md-push-1 ">
					<ul class="fh5co-footer-links">
						...
						<li><a href="index.php">Find Buyers</a></li>
