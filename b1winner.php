		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 text-center menu-1">
					<ul>
						<li class="active"><a href="enter.php">Home</a></li>
...
<span id="hours">&nbsp &nbsp &nbsp{{hours}}</span><span id="min">{{minutes}}</span><span id="sec">{{sec}}</span> <span id="ampm">{{ampm}}</span>
	...
	<div class="row align-items-center my-5">
      ...
      <div class="col-lg-7">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="images/1985London.jpg" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light"> Vintage London Coach Sterling </h1>
        <p>London Coaches was a former bus and coach operator operating open top tourist services in London and commuter services from Kent to London. This is One from 1985. </p>
	
		<p>London Coaches originated from the London Transport Tours and Charters division. In January 1986 London Transport revamped the division and formed the Original London Transport Sightseeing Tour brand, to operate a fleet of 50 modified open and closed topped AEC Routemaster buses, on sightseeing tours of London.</p>
    ...
    <div class="card text-white bg-secondary my-5 py-4 text-center">
	  ...
	  <?php
        echo $alert;		
      ?>
        <p class="text-white m-0"> OOPS - Your are OUT OF TIME !!
		</p>
		<br><br><br>
		<div class="row">
		<div class="col-md-4">
 ...
 echo $lastprice['username'].'  WON the auction by bidding amount of Rs.'.$lastprice['price'].' /- ';
 
 
 echo '<br><br>'.' Thanks '.$lastprice['username']. ' for joining us - BidMe.Co ';
