...
<span id="hours">&nbsp &nbsp &nbsp{{hours}}</span><span id="min">{{minutes}}</span><span id="sec">{{sec}}</span> <span id="ampm">{{ampm}}</span>
  ...
  <div class="row align-items-center my-5">
      ...
      <div class="col-lg-7">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="images/tambura.jpeg" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light"> Antique Tambura </h1>
        <p> The tambura is a stringed instrument that is played as a folk instrument in Serbia, Macedonia, Croatia and Bulgaria. It has doubled steel strings and is played with a plectrum, in the same manner as a mandolin.</p>
      </div>
      <!-- /.col-md-4 -->
