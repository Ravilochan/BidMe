...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
    <div id="fh5co-logo"><span> Articrafts &nbsp &nbsp &nbsp </span></div>
	<div id="app"> 
                              <div id="main">
							   <div id="fullDate">
...
<span id="hours">{{hours}}</span><span id="min">{{minutes}}</span><span id="sec">{{sec}}</span> <span id="ampm">{{ampm}}</span>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="contact.php">Help desk</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <h1>   <div id="fh5co-logo"><a href="index.php" style="color:black; font:bold;">Bid<span>Me</span></a></div></h1>
	<!--  <img src="images/logoicon.png">-->
	  <br><br>
        <div class="list-group">
          <a href="#" class="list-group-item active">Artifacts</a>
          <a href="category2.php" class="list-group-item">Automotives</a>
		  <a href="category4.php" class="list-group-item">Jewellery</a>
		   <a href="category3.php" class="list-group-item">Collectables</a>
          <a href="#" class="list-group-item">Books & Paintings</a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="images/wallclock.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/ring.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/hero_freeforall.jpg" alt="Third slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/Clocks.png" alt="First slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/coins.jpg" alt="First slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/surya-god.jpg" alt="First slide">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b3.php"><img class="card-img-top" src="images/wallclock.jpg" alt="first"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Antique Table Clock </p>
                </h4>
                <h5></h5>
            
				<h5> Timing :</h5> 08:00 AM - 12:00 PM     <p class="card-text">
				<form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod1" value=" Bid ">
        </form> </p>
              </div>
              <div class="card-footer">
                 <h5 class="text-muted">Worth :&#9733; &#9733; &#9733; &#9733; &#9734;</h5>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b2.php"><img class="card-img-top" src="images/dagger.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Ancient Indian Temple Dagger </p>
                </h4>
                <h5> Timing :</h5> 12:00 PM - 04:00 PM
                <p class="card-text">
				
				<form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod2" value=" Bid ">
        </form></p>
              </div>
              <div class="card-footer">
                <h5 class="text-muted">Worth :&#9733; &#9733; &#9733; &#9733; &#9734;</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/bowl.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          <p> Antique Handmade Utensils ( Bowl )</p>
                </h4>
                				<h5> Timing :</h5> 04:00 PM - 08:00 PM 
                <p class="card-text"><form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod3" value=" Bid ">
        </form></p>
              </div>
              <div class="card-footer">
                <h5 class="text-muted">Worth :&#9733; &#9733; &#9734; &#9734; &#9734;</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/balance.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
               <p> Antique Balance </p>
                </h4>
                <h5> Timing :</h5> 08:00 AM - 012:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod4" value=" Bid ">
        </form></p>
              </div>
              <div class="card-footer">
                <h5 class="text-muted">Worth :&#9733; &#9733; &#9733; &#9733; &#9733;</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/blackguy.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
             ...
             <h5> Timing :</h5> 12:00 PM - 04:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod5" value=" Bid ">
        </form></p>
              </div>
              <div class="card-footer">
                <h5 class="text-muted">Worth :&#9733; &#9733; &#9733; &#9733; &#9733;</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/furniture.png" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                <p> Antique Teak Home Furniture </p>
                </h4>
<h5> Timing :</h5> 04:00 PM - 08:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
				 <input type="submit" class="btn btn-info" name="prod6" value=" Bid ">
        </form></p>
              </div>
              <div class="card-footer">
                <h5 class="text-muted">Worth :&#9733; &#9733; &#9733; &#9733; &#9734;</h5>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-4 wow fadeInLeft" data-wow-delay="0.6s">
						<h2><strong style="color:black;">BidMe</strong> .Co</h2>
					...
					<div class="col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.9s">
						<address>
							<h3 style="color:black">Visit Office</h3>
