...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
    <div id="fh5co-logo"><span> Collectables &nbsp &nbsp &nbsp </span></div>
	<div id="app"> 
                              <div id="main">
							   <div id="fullDate">
	...
	<!--  <img src="images/logoicon.png">-->
	  <br><br>
        <div class="list-group">
          ...
          <a href="#" class="list-group-item active">Collectables</a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/grammy.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/nihonga_4.jpg" alt="Third slide">
            </div>
			<div class="carousel-item ">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b6.php"><img class="card-img-top" src="images/chest.jpeg" alt="first"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Antique ChestBox </p>
                </h4>
                <h5></h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/chinese.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Ancient Chinese Sculptures & Statues </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/calender.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          <p> Antique Handmade Goods</p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/roman.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
               <p>Roman Findings </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/lamp.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
              <p> Rare Laamps </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/dsc.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                <p> Antique Teak Music  </p>
                </h4>
<h5> Timing :</h5> 04:00 PM - 08:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
