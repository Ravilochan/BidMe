...
session_start();
 ...
 $db=mysqli_connect("localhost","root","","bidme");
 mysqli_select_db($db,'bidtable3');
 ...
 $sq="SELECT * FROM bidtable3";
 $record=mysqli_query($db,$sq);

 $sql1="SELECT * FROM bidtable3 ORDER BY no DESC LIMIT 1";
 ...
 $lastprice=mysqli_fetch_assoc($lastone);
  ...
  $s="SELECT * FROM bidtable3 WHERE price='$subprice'";
  ...
  $num=mysqli_num_rows($result);
	...
	$l=" INSERT INTO bidtable3(username,price) VALUE ('$username','$subprice')";
...
<span id="hours">&nbsp &nbsp &nbsp{{hours}}</span><span id="min">{{minutes}}</span><span id="sec">{{sec}}</span> <span id="ampm">{{ampm}}</span>
  ...
  <div class="row align-items-center my-5">
      ...
      <div class="col-lg-7">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="images/wallclock.jpg" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Antique Tableclock</h1>
        <p> </p>
      </div>
      <!-- /.col-md-4 -->
...
<br>
 ...
 echo '<br><br>'. ' This bidding last until 12 PM . Winner will be announced only after completion of the whole Bidding . ';
  ...
  <footer id="fh5co-footer" role="contentinfo">
      ...
      <div class="row row-pb-md">
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 col-md-push-1 " style="padding-left:100px;">
