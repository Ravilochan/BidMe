...
<html>
	...
	<title> OOPS! &mdash; Out of Time</title>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="display-t">
						...
						<div id="app"> 
							...
							<h2 class="mb30"> You are out of time </h2>
							
									   
							<div class="col-md-12 text-center animate-box">
					<p><a href="category.php" class="btn btn-primary with-arrow"> Participate in other Biddings </a></p>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-4 wow fadeIn" data-wow-delay="0.9s">
						<address>
							...
							<p><i class="fa fa-envelope-o too-icon"></i> BidMe@gmail.com <small> BidMe.com</small></p>
						</address>
					</div>
