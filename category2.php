...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
    <div id="fh5co-logo"><span> Automotives &nbsp &nbsp &nbsp </span></div>
	<div id="app"> 
                              <div id="main">
							   <div id="fullDate">
	...
	<!--  <img src="images/logoicon.png">-->
	  <br><br>
        <div class="list-group">
          <a href="category1.php" class="list-group-item ">Artifacts</a>
          <a href="#" class="list-group-item active">Automotives</a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="images/volvo.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/cut35.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/121.jpg" alt="Third slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/100.jpg" alt="First slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/sliders.png" alt="First slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/trailer.jpg" alt="First slide">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b1.php"><img class="card-img-top" src="images/1985London.jpg" alt="first"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> 1985 London Sterling </p>
                </h4>
                <h5></h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b5.php"><img class="card-img-top" src="images/car.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Vintage Mustang </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/car_0.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          <p> Antique Luxury Cars </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/car2.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
               <p> Antique Open-tops </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/HF14.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
              <p> Vinatge Buggy ( Budget ) </p>
                </h4>
             <h5> Timing :</h5> 12:00 PM - 04:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/grandprix.png" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                <p> Antique Grand Prix Race Car </p>
                </h4>
<h5> Timing :</h5> 04:00 PM - 08:00 PM
                <p class="card-text"><form action="catsel1.php" method="post">
