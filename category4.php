...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
    <div id="fh5co-logo"><span> Jewellery &nbsp &nbsp &nbsp </span></div>
	<div id="app"> 
                              <div id="main">
							   <div id="fullDate">
	...
	<!--  <img src="images/logoicon.png">-->
	  <br><br>
        <div class="list-group">
          ...
          <a href="#" class="list-group-item active">Jewellery</a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="images/ring.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/grammy.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="images/coins.jpg" alt="Third slide">
            </div>
			<div class="carousel-item ">
              <img class="d-block img-fluid" src="images/ring.jpg" alt="First slide">
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b3.php"><img class="card-img-top" src="images/jewelry.jpg" alt="first"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Antique Stones & Necklaces </p>
                </h4>
                <h5></h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="b2.php"><img class="card-img-top" src="images/diamonds.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <p> Ancient Diamonds </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
          <p> Antique Handmade Ornaments </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/chest.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/surya-god.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
              <p> Ancient Idols </p>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="images/ring.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                <p> Precious Rings </p>
                </h4>
