...
<html>
	...
	<title>BidMe &mdash; About Us</title>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							...
							<h2 class="mb30">We are some Awesome team</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row animate-box" data-animate-effect="fadeInUp">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<h2> Facts <small> about us </small></h2>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p><a href="LogIn.php" type="button" class="btn btn-default">Get Into Bidding </a></p>
				</div>
			</div>
		</div>
	</div>
