...
<span id="hours">&nbsp &nbsp &nbsp{{hours}}</span><span id="min">{{minutes}}</span><span id="sec">{{sec}}</span> <span id="ampm">{{ampm}}</span>
  ...
  <div class="row align-items-center my-5">
      ...
      <div class="col-lg-7">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="images/chest.jpeg" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Ancient Marine Binoculars</h1>
        <p> 
The Ancient Chest is a structure exclusive to Don't Starve Together, naturally spawning in the Ruins next to an Ancient Pseudoscience Station. It works similar to a Chest, but has 6 slots instead of 9, and cannot be destroyed. Its use is to input items to recieve Replica Relic Blueprints, or solve the Metheus Puzzles.
</p>
      </div>
      <!-- /.col-md-4 -->
